            ...
            contents.zones[0].content[currentIndex].type === "image" && (
              <div className="basic-list-group image-preview-container media-content nnnn">
                <img
                  ...
                  src={`https://ssapi.trendysignage.com/${contents.zones[0].content[currentIndex].url}`}
                  alt="media-img"
                />
              </div>
            )}
              ...
              contents.zones[1].content[current1Index].type === "image" && (
                <div className="basic-list-group image-preview-container media-content">
                  <img
                    ...
                    src={`https://ssapi.trendysignage.com/${contents.zones[1].content[currentIndex].url}`}
                    alt="media-img"
                  />
                </div>
              )}
                ...
                contents.zones[1].content[current1Index].type === "image" && (
                  <div className="basic-list-group image-preview-container media-content">
                    <img
                      ...
                      src={`https://ssapi.trendysignage.com/${contents.zones[1].content[current1Index].url}`}
                      alt="media-img"
                    />
                  </div>
                )}
              ...
              contents.zones[2].content[current2Index].type === "image" && (
                <div className="basic-list-group image-preview-container media-content">
                  <img
                    ...
                    src={`https://ssapi.trendysignage.com/${contents.zones[2].content[current2Index].url}`}
                    alt="media-img"
                  />
                </div>
              )}
