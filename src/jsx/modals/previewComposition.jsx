                ...
                contentnew.Zone1[currentIndex].type === "image" && (
                  <div className="basic-list-group image-preview-container media-content">
                    <img
                      ...
                      //src={`https://dsapi.trendysignage.com/${contentnew.Zone1[currentIndex].url}`}
                      src={url}
                      alt="media-img"
                    />
                  </div>
                ...
                contentnew.Zone2[current1Index].type === "image" && (
                  ...
                  >
                    <img
                      ...
                      //src={`https://dsapi.trendysignage.com/${contentnew.Zone2[current1Index].url}`}
                      src={url1}
                      alt="media-img"
                    />
                  </div>
                ...
                contentnew.Zone3[current2Index].type === "image" && (
                  <div className="basic-list-group image-preview-container media-content">
                    <img
                      ...
                      //src={`https://dsapi.trendysignage.com/${contentnew.Zone3[current2Index].url}`}
                      src={url2}
                      alt="media-img"
                    />
                  </div>
